    ...
    \begin{columns}[c]
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                \item \textbf{Inspiration :} projet ModQuad (Université de Pennsylvanie) \cite{saldana_modquad_2018}, un essaim de drones reconfigurable.
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                \begin{enumerate}
                    ...
                    \item Optimiser la commande distribuée de l'essaim (réduire les calculs, échanges d'informations).
                \end{enumerate}
            \end{itemize}
        \end{column}
        \begin{column}{0.4\textwidth}
