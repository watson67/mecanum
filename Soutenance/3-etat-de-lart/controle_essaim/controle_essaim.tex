...
\begin{frame}[c]{Approches de contrôle \cite{jamshidpey_centralization_2024}}
    \vfill
    ...
    \begin{columns}[c,totalwidth=\textwidth]
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Les robots s'accordent sur une valeur commune (ex: position, vitesse) en communiquant avec leurs voisins.
            \end{itemize}
            \vspace{0.3cm}
