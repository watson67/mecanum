...
Les méthodes ont été testé en faisant réaliser à un essaim de 4 robots un parcours en carré en partant d'une position initiale fixée.
Un échantillon de résultat pour la méthode classique est donnée ci-dessous à titre d'exemple. Les robots doivent maintenir 50cm d'inter-distance avec leurs voisins, en formant une formation carré. Deux robots sont considérés comme voisins s'ils sont adjacents et forment un côté du carré. Une perturbation est également créée en déplaçant un robot à la main durant l'expérience. Un tableau récapitulatif des résultats obtenus durant ce stage est ensuite donné.
...
La méthode prédictive a réduit considérablement le nombre d'échanges de données tout en maintenant la formation. De plus, elle a permis de diminuer la charge CPU, ce qui prouve l'intérêt de cette méthode. 
