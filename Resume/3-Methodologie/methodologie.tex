...
Dans ce cadre, l’algorithme calcule deux contributions de commande pour chaque agent : $u_i^\alpha$, qui régule les distances inter‑robots vers leurs valeurs désirées, et $u_i^\gamma$, qui déplace le robot vers un point cible. La commande appliquée est la somme des deux : $u_i = u_i^\alpha + u_i^\gamma$.
