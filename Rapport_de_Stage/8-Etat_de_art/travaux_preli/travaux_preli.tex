...
\begin{wrapfigure}{r}{0.3\textwidth} \vspace{-0.2cm} \centering \includegraphics[width=\linewidth]{8-Etat_de_art/travaux_preli/pic/crazyflie_structure.PNG} \caption{UAV eSWARM} \label{fig:crazyflie_struct} \vspace{-0.5cm} \end{wrapfigure}
